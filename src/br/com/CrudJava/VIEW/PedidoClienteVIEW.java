 ...
 * @author Leroy2
 */
public class PedidoClienteVIEW extends javax.swing.JFrame {

       List<ClienteMODEL> clienteList = new ArrayList<>();
    ResultSet rs;
    public PedidoVIEW obj;
   
    
    
    public PedidoClienteVIEW() {
        initComponents();
    ...
    private void tbl_clienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_clienteMouseClicked
        if(evt.getClickCount() == 1){
            ...
            obj.cod_cliente = Integer.parseInt(String.valueOf(tbl_cliente.getValueAt(linha, 0)));
            obj.txt_cliente.setText(String.valueOf(tbl_cliente.getValueAt(linha, 1)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PedidoClienteVIEW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PedidoClienteVIEW().setVisible(true);
            }
        });
    }
