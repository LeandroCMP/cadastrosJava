...
public class PedidoVendedorVIEW extends javax.swing.JFrame {
    ...
    private void tbl_vendedorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_vendedorMouseClicked
        if(evt.getClickCount() == 1){
            ...
            obj.cod_vendedor=Integer.parseInt(String.valueOf(tbl_vendedor.getValueAt(linha, 0)));
            obj.txt_vendedor.setText(String.valueOf(tbl_vendedor.getValueAt(linha, 1)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PedidoVendedorVIEW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PedidoVendedorVIEW().setVisible(true);
            }
        });
    }
